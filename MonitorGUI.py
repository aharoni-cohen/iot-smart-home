    ...
    def update_mess_win(self,text):
        ...
        if flout_temp>30:
            if(b1==0):
                b1=1
                b3=1
                self.eRecMess.append("air conditioner Faild: temp emergency! turn on emergency air conditioner")
                self.mc.publish_to('pr/home/Hodaya_conditioner/sts', '"value":1')
                if(b2==0):
                    self.mc.publish_to('pr/home/Hodaya_alarm/sts', '"value":1')
        else:
            if(b1==1):
                self.eRecMess.append("the system is ok")
                self.mc.publish_to('pr/home/Hodaya_conditioner/sts', '"value":1')
                b1=0


            # publish code
        if flout_Humidity>76:
            if(b2==0):
                b2=1
                b3=1
                self.eRecMess.append("leak detected , turn on emergency pump")
                self.mc.publish_to('pr/home/Hodaya_pump/sts', '"value":1')
                if(b1==0):
                    self.mc.publish_to('pr/home/Hodaya_alarm/sts', '"value":1')
        else:
            if(b2==1):
        ...
        if (flout_temp<=30) and (flout_Humidity<=76):
            print(b3)
            print("222")
            if(b3==1):
                print("3333")
